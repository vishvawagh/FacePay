...
function getUserName() {
    if (keepLoggedIn == "yes") {
        currentUser = JSON.parse(localStorage.getItem('shopkeeper'));
    } else {
        currentUser = JSON.parse(sessionStorage.getItem('shopkeeper'));
    }
}
...
const uploadProcess = async () => {
    ...
    // gs://facepay-5d2e9.appspot.com/ProfileImages/Nikita@gmailcom
    // gs://facepay-5d2e9.appspot.com/ProfileImages/767221216450
